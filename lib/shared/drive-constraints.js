...
/**
 * @summary Get drive feedback in an object, if any
 * @function
 * @public
 *
 * @description
 * If the drive-image combination results in a warning or error, this function
 * returns an object containing the feedback type ('error', 'warning') and the
 * feedback message.
 *
 * @param {Object} drive - drive
 * @param {Object} image - image
...
exports.getDriveImageCompatibilityStatus = (drive, image) => {
  ...
  if (Boolean(drive) && !exports.isDriveLargeEnough(drive, image)) {
    return {
      type: exports.COMPATIBILITY_STATUS_TYPES.ERROR,
  ...
  if (Boolean(drive) && !exports.isDriveSizeRecommended(drive, image)) {
    return {
      type: exports.COMPATIBILITY_STATUS_TYPES.WARNING,
      message: exports.COMPATIBILITY_STATUS_MESSAGES.NOT_RECOMMENDED
    };
  }
