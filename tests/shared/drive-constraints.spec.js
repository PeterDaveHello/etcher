...
describe('Shared: DriveConstraints', function() {
  ...
  describe('.getDriveImageCompatibilityStatus', function() {
    ...
    describe('given the drive is smaller than the recommended size', () => {
      ...
      it('should return the smaller than recommended size warning', function() {
        ...
        m.chai.expect(result).to.deep.equal({
          ...
          message: constraints.COMPATIBILITY_STATUS_MESSAGES.NOT_RECOMMENDED
        });
      });
    });
    ...
    describe('given that everything is wrong', () => {
    ...
    describe('given everything but source drive is wrong', () => {
    ...
    describe('given everything but source drive and system drive is wrong', () => {
    ...
    describe('given everything but source, system, and too small drive is wrong', () => {
